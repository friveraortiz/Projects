...
public class LoginFormPanel extends JPanel 
{
   ...
   public LoginFormPanel() 
   {
		...
		// Set the tooltip text in the JTextField Object 
		passwordField.setToolTipText("User Secret Word or Phrase"); 
				
		// The JButton Object
		signInBtn = new JButton("Sign In");
		// Set the tooltip text in the JButton Object 
		signInBtn.setToolTipText("Connects to the Forensic-Ready Logger System"); 
		...
		signInBtn.addActionListener(new ActionListener() 
		{
			...
			public void actionPerformed(ActionEvent e) 
			{
				...
				// it launches the Forensic Ready Logger Main Menu
		...
		Border innerBorder = BorderFactory.createTitledBorder("Login Information");
		Border outerBorder = BorderFactory.createEmptyBorder(7, 7, 7, 4);
