  ...
  before(): databaseMethods()
   {
      ...
      */
      ...
      {	
    	 ...
    	 System.out.println("Aspect Oriented File : " + "3");
    	 ...
    	 */
	     ...
	     System.out.println("*** VALIDATING USER CONNECTED METHOD AOP 3 ***");
	     System.out.println("Current User  : " + currentUser);
   ...
   //after () returning(Object methodReturnValue1): connect() && args()
   {
      ...
      /*
      System.out.println("*** AFTER CONNECTING AOP 3 ***");
         ...
         if(connectProjectType1.equals("Parameter"))
         {
            ...
            */
            ...
            if(connectProjectMethodReturnValue1.toString().contains(value))
            {
               ...
               /*
               System.out.println("*** USER REALLY CONNECTED (PARAMETER ) AOP3 ***");
            ...
            if(connectProjectType1.equals("ReturnType"))
            {
               ...
               */
               ...
               if(connectProjectMethodReturnValue1.toString().contains(value))
               {
                  ...
                  /*
                  System.out.println("*** USER REALLY CONNECTED (RETURN TYPE ) AOP3 ***");
                  System.out.println("User Name     : " + value);
                  System.out.println("User Counter  : " + userCounter);
                  System.out.println("Current User  : " + currentUser);
                  */
   ...
   public void assignUser()
   {
	  ...
	  /*
	  System.out.println("*** USER TRYING TO CONNECT AOP3 ***");
	  System.out.println("Current User: " + currentUser);
	  */
   }
